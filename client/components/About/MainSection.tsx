    ...
    <section>
      <ContentWrapper>
        <div className="about flex flex-col gap-10">
          <div className="md:pl-[9%] md:max-w-5xl">
            <h2 className="font-playfair text-[#120d07] text-2xl lg:text-5xl font-bold capitalize leading-[2.5rem] md:leading-[3.5rem]">
              Seyi Vibez, Whose Real Name Is Oluwaloseyi Balogun, Is a popular
              Afrobeat Singer And Songwriter, known for his unique "street-pop"
              sound.
            </h2>
          </div>
          ...
          <div ref={containerRef} className="relative flex flex-col gap-20">
            ...
            {/* First Section */}
            <div className="flex flex-col md:flex-row items-start justify-start gap-28">
            ...
            >
              <h2 className="font-playfair text-2xl md:text-4xl">
                Seyi is known for his smooth vocals and catchy melodies
              </h2>
              <div className="">
                <Image
